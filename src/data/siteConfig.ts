...
export const siteConfig = {
  ...
  about: {
    ...
    bio: [
      "Welkom op mijn portfolio! Ik ben een (bijna) afgestudeerd in de richting Architectuur en heb daarnaast mijn hbo diploma Bouwkunde behaald. In dit portfolio presenteer ik een selectie van mijn werk en ontwikkeling binnen het vakgebied.",
